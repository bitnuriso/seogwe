...
<label><input id="autoEachPage" type="checkbox"> 페이지마다 자동 감지</label>
...
async function drawPreview(resetDocument=false){
  ...
  renderCrop();
  updateModeUI();
  if(!$("allPages").checked && $("autoEachPage").checked && !pageCrops[pageIndex]) autoDetectContent();
